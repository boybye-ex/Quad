import { Campus, Category, User, Listing, Conversation, Message } from '@/types';

export const mockCampuses: Campus[] = [
  { id: 'campus_1', name: 'Stanford University', shortName: 'Stanford', location: 'Stanford, CA' },
  { id: 'campus_2', name: 'UC Berkeley', shortName: 'Berkeley', location: 'Berkeley, CA' },
  { id: 'campus_3', name: 'MIT', shortName: 'MIT', location: 'Cambridge, MA' },
  { id: 'campus_4', name: 'Harvard University', shortName: 'Harvard', location: 'Cambridge, MA' },
  { id: 'campus_5', name: 'UCLA', shortName: 'UCLA', location: 'Los Angeles, CA' },
  { id: 'campus_6', name: 'Columbia University', shortName: 'Columbia', location: 'New York, NY' },
  { id: 'campus_7', name: 'Yale University', shortName: 'Yale', location: 'New Haven, CT' },
  { id: 'campus_8', name: 'Princeton University', shortName: 'Princeton', location: 'Princeton, NJ' },
  { id: 'campus_9', name: 'University of Michigan', shortName: 'Michigan', location: 'Ann Arbor, MI' },
  { id: 'campus_10', name: 'Carnegie Mellon', shortName: 'CMU', location: 'Pittsburgh, PA' },
];
...
export const mockListings: Listing[] = [
  ...
  {
    id: 'listing_5',
    title: 'Ride to SF Airport - Friday 3PM',
    description: 'Have 3 seats available. Split gas. Going to SFO terminal.',
    price: 15,
    priceType: 'fixed',
  ...
  },
  {
    ...
    description: 'Need someone to cover my shift at Coupa Cafe this Saturday 8am-2pm.',
    price: 0,
    priceType: 'free',
  ...
  {
    id: 'listing_10',
    title: '2BR Apartment - Fall Quarter',
    description: 'Looking for 1 roommate. Close to Caltrain, parking included.',
    price: 1200,
    priceType: 'monthly',
    category: mockCategories[2],
